...
public class RoleController {
	...
	public RoleResponse save(
			@Parameter(description = "role request for the role to be saved", required = true) @Valid @RequestBody RoleRequest request) {
	...
	public RoleResponse update(
			@Parameter(description = "Id of the role for which role to be update", required = true) @PathVariable Long roleId,
			@Parameter(description = "role request for the role to be update", required = true) @Valid @RequestBody RoleRequest request) {
