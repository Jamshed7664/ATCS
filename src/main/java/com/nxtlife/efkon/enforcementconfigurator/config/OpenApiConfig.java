package com.nxtlife.efkon.enforcementconfigurator.config;
...
public class OpenApiConfig {
	...
	public OpenAPI customOpenAPI() {
		...
		return new OpenAPI().security(Arrays.asList(securityRequirement)).components(new Components().securitySchemes(securitySchemeMap))
				.info(new Info().title("Enforcement Configurator API")
						.description("Enforcement Configurator Rest Api Documentation").version("v1")
