...
import com.nxtlife.efkon.enforcementconfigurator.config.Aws;
...
import com.nxtlife.efkon.enforcementconfigurator.ex.UploadException;
...
public class AwsS3FileStorageServiceImpl<T> implements FileStorageService<T> {
	...
	@Value("${efkon.s3.bucket}")
	private String s3Bucket;

	@Value("${efkon.aws.accessKeyId}")
	private String accessKey;

	@Value("${efkon.aws.secretKey}")
